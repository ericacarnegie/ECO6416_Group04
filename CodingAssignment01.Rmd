...
plot(relevant_data$Charges, relevant_data$Age)
plot(relevant_data$Charges, relevant_data$BMI)
plot(relevant_data$Charges, relevant_data$Children)
plot(relevant_data$Age, relevant_data$BMI)
plot(relevant_data$Age, relevant_data$Children)
plot(relevant_data$BMI, relevant_data$Children)
```
