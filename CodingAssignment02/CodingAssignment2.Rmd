...
The variables that test significant in a two-tailed test using $\alpha = 0.2$ is Age, BMI, Smoker, WinterSprings, WinterPark, and Oviedo. They are all less than 0.2 making them signifcant and we can reject the null hypothesis.
